...
package pdp_10dec2018.loadgroupbpowercheckdatafromfiles_0_1;
...
/**
 * Job: LoadGroupBPowerCheckDataFromFiles Purpose: <br>
 * Description:  <br>
 * @author pulkittestmail@gmail.com
 * @version 7.0.1.20180411_1414
 * @status 
 */
public class LoadGroupBPowerCheckDataFromFiles implements TalendJob {
...
public String getDataDirectory(){
	...
	private final String jobName = "LoadGroupBPowerCheckDataFromFiles";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				LoadGroupBPowerCheckDataFromFiles.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(LoadGroupBPowerCheckDataFromFiles.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row_Implicit_Context_RegexStruct implements routines.system.IPersistableRow<row_Implicit_Context_RegexStruct> {
    final static byte[] commonByteArrayLock_PDP_10DEC2018_LoadGroupBPowerCheckDataFromFiles = new byte[0];
    static byte[] commonByteArray_PDP_10DEC2018_LoadGroupBPowerCheckDataFromFiles = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PDP_10DEC2018_LoadGroupBPowerCheckDataFromFiles.length) {
				if(length < 1024 && commonByteArray_PDP_10DEC2018_LoadGroupBPowerCheckDataFromFiles.length == 0) {
   					commonByteArray_PDP_10DEC2018_LoadGroupBPowerCheckDataFromFiles = new byte[1024];
				} else {
   					commonByteArray_PDP_10DEC2018_LoadGroupBPowerCheckDataFromFiles = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PDP_10DEC2018_LoadGroupBPowerCheckDataFromFiles, 0, length);
			strReturn = new String(commonByteArray_PDP_10DEC2018_LoadGroupBPowerCheckDataFromFiles, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PDP_10DEC2018_LoadGroupBPowerCheckDataFromFiles) {
 ...
 */
  ...
  String directory_tFileList_1 = context.dataDirectory+context.groupBFilesDirectory+context.groupBPowerCheckFilesDirectory;
 ...
 */
    ...
    public static void main(String[] args){
        final LoadGroupBPowerCheckDataFromFiles LoadGroupBPowerCheckDataFromFilesClass = new LoadGroupBPowerCheckDataFromFiles();

        int exitCode = LoadGroupBPowerCheckDataFromFilesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = LoadGroupBPowerCheckDataFromFiles.class.getClassLoader().getResourceAsStream("pdp_10dec2018/loadgroupbpowercheckdatafromfiles_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = LoadGroupBPowerCheckDataFromFiles.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : LoadGroupBPowerCheckDataFromFiles");
        }
 ...
 *     on the 17 December, 2018 11:53:44 AM IST
 ************************************************************************************************/